...
if (GIT_EXECUTABLE)
    macro(GIT_WC_INFO dir prefix)
        execute_process(
            COMMAND ${GIT_EXECUTABLE} rev-parse --short --verify -q HEAD
        ...
        if (NOT ${GIT_error} EQUAL 0)
            ...
            execute_process(
                COMMAND ${GIT_EXECUTABLE} rev-parse --verify -q --short HEAD
                WORKING_DIRECTORY ${dir}
                ERROR_VARIABLE GIT_error
            ...
            execute_process(
                COMMAND ${GIT_EXECUTABLE} name-rev ${${prefix}_WC_REVISION_HASH}
                WORKING_DIRECTORY ${dir}
            ...
            execute_process(
                ...
                WORKING_DIRECTORY ${dir}
                OUTPUT_VARIABLE ${prefix}_LAST_COMMIT_DATE
                OUTPUT_STRIP_TRAILING_WHITESPACE
            )

            execute_process(
                COMMAND ${GIT_EXECUTABLE} rev-parse -q --abbrev-ref HEAD
                WORKING_DIRECTORY ${dir}
        ...
        execute_process(
            COMMAND ${GIT_EXECUTABLE} config --get-regexp "^svn-remote"
            WORKING_DIRECTORY ${dir}
